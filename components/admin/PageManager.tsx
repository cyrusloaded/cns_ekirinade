            ...
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              ...
              <div className="grid grid-cols-1 gap-3 sm:flex sm:flex-wrap">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-slate-100 px-5 py-3 text-sm font-bold text-slate-600 transition hover:bg-slate-200 disabled:opacity-70">
                  {isRefreshing ? (
                  ...
                  <div className="flex flex-col gap-4 md:flex-row md:items-center md:gap-6">
                    ...
                    <div className="flex w-full justify-end gap-2 md:w-auto md:self-center">
                      ...
                      <button
                        ...
                        disabled={isDeleting}
                        className="rounded-full p-3 text-red-600 transition hover:bg-red-50 disabled:opacity-70"
                        title="Delete page">
                        {isDeleting ? (
            ...
            <div className="flex flex-col gap-3 border-t border-slate-100 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-5 sm:py-5 lg:px-8">
              ...
              <div className="grid grid-cols-1 gap-3 sm:flex sm:justify-end">
                ...
                <button
                  ...
                  disabled={isSaving}
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-[#320056] px-7 py-3 text-sm font-bold text-white shadow-lg shadow-[#320056]/20 disabled:opacity-70">
                  {isSaving ? (
                    <Loader2 size={16} className="animate-spin" />
                  ) : (
                    <Save size={16} />
