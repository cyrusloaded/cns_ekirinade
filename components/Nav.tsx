  ...
  return (
    <>
      <header
        ...
        <nav className="mx-auto flex h-16 w-full items-center justify-between gap-2 px-4 sm:px-6 lg:h-20 lg:px-8 xl:px-24">
          {/* Logo + Brand */}
          <Link
            href={brand.href}
            className="flex min-w-0 shrink-0 items-center gap-2 sm:gap-3"
            aria-label={`${brand.title} home`}>
            <div className="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden ring-[#320056]/10 sm:h-11 sm:w-11">
              <Image
                src={logoSrc}
            ...
            <div className="min-w-0">
              ...
              <p className="hidden truncate text-xs font-medium text-[#005768] sm:block">
                {brand.subtitle}
              </p>
            </div>
          </Link>
          ...
          {/* Desktop Navigation */}
          <div className="hidden min-w-0 flex-1 items-center justify-end gap-0.5 overflow-x-auto lg:flex lg:gap-1 xl:gap-2">
            {items.map((page) => {
              ...
              return (
                <Link
                  key={page.href}
                  href={page.href}
                  className={`shrink-0 whitespace-nowrap px-2.5 py-2 text-xs font-semibold lg:px-3 xl:px-4 xl:text-sm ${
                    active
          ...
          <button
            ...
            className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 shadow-sm transition hover:border-[#320056]/20 hover:text-[#320056] lg:hidden">
