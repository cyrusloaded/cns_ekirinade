        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-8">
            <div className="inline-flex items-center gap-2 bg-[#005768]/5 px-5 py-2 rounded-full">
              ...
              <span className="text-[#005768] font-semibold text-xs uppercase tracking-widest">
                {content.badge}
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                asChild
                className="bg-gradient-to-r from-[#320056] to-[#410171] text-white px-8 py-7 cursor-pointer rounded-2xl font-semibold shadow-lg hover:scale-[1.02] transition">
                <Link href={content.primaryCta.href}>
                  {content.primaryCta.label} <ArrowRight />
                </Link>
              </Button>
              ...
              <Button
                asChild
                variant="outline"
                className="border border-gray-300 text-[#320056] px-8 py-7 cursor-pointer rounded-2xl font-semibold hover:bg-white transition">
          ...
          <div className="lg:col-span-6 relative">
            ...
            <div className="absolute bottom-6 left-4 sm:left-[-4%] bg-white p-6 rounded-2xl shadow-xl w-[260px] z-10">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-bold text-[#320056] text-lg leading-tight">
                  {content.floatingCard.title.split(" ").slice(0, 1).join(" ")}{" "}
                  <br />{" "}
                  {content.floatingCard.title.split(" ").slice(1).join(" ")}
                </h3>
              </div>
              <p className="text-sm text-gray-500 leading-relaxed">
                {content.floatingCard.description}
              </p>
            </div>
          </div>
        </div>
